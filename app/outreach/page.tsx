  ...
  return (
    <div className="space-y-6">
      ...
      {loading ? <LoadingSpinner /> : campaigns.length === 0 ? (
        <EmptyState icon="📧" title="No emails sent yet" hint="Compose your first outreach email. Sends from your verified sender (set it per brand in Settings)." action={<Button onClick={() => setOpen(true)}>Compose</Button>} />
      ) : (
