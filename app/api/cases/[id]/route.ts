...
export const PATCH = withApi(PATCH__impl as any, { route: "/api/cases/[id]", method: "PATCH" });
export const DELETE = withApi(DELETE__impl as any, { route: "/api/cases/[id]", method: "DELETE" });
