...
const FIELDS = ['account_id','brand_id','company_id','contact_id','subject','description','status','priority','assigned_to'];
...
export async function GET(request: NextRequest) {
  ...
  try { return NextResponse.json(await casesRepo.list(accountId, brandId)); }
