...
export const GET = withApi(GET__impl as any, { route: "/api/automations", method: "GET" });
export const POST = withApi(POST__impl as any, { route: "/api/automations", method: "POST" });
